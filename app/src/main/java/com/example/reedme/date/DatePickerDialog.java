...
package com.example.reedme.date;
...
import com.example.reedme.helper.HapticFeedbackController;
import com.example.reedme.helper.TypefaceHelper;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(mDayOfWeekView != null) mDayOfWeekView.setBackgroundColor(Util.darkenColor(mAccentColor));
    ...
    private void setCurrentView(final int viewIndex) {
        ...
        switch (viewIndex) {
            case MONTH_AND_DAY_VIEW:
                ObjectAnimator pulseAnimator = Util.getPulseAnimator(mMonthAndDayView, 0.9f,
                        1.05f);
                if (mDelayAnimation) {
