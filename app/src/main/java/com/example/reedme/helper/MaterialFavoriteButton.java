...
public class MaterialFavoriteButton extends ImageView {
  ...
  private static final int FAVORITE_STAR_BLACK = R.mipmap.ic_favorite_white_24dp;
  private static final int FAVORITE_STAR_BORDER_BLACK = R.mipmap.ic_favorite_border_white_24dp;
   ...
   *
   * @param listener the {@link OnFavoriteChangeListener} will be called
   */
   ...
   * Set a listener will be called when the favorite state is changed.
   *
   * @param listener the {@link OnFavoriteAnimationEndListener} will be
   * called
   */
